...
def save_articles_per_date(results,target_date):
    ...
    output_dir = os.path.join("Output", "per_date")
    ...
    print(f"Articles have been saved in the 'Output/per_date' directory.")

def save_articles_per_article(results):
    # Ensure the Output/per_article directory exists
    output_dir = os.path.join("Output", "per_article")
    os.makedirs(output_dir, exist_ok=True)
    
    for article in results:
        # Format the title to use as the filename
    ...
    print(f"Articles have been saved in the 'Output/per_article' directory.")
